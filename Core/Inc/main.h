...
#define Ballast_SW_Pin GPIO_PIN_3
#define Ballast_SW_GPIO_Port GPIOA
...
#define GPIO_Spare_PE7_Pin GPIO_PIN_7
#define GPIO_Spare_PE7_GPIO_Port GPIOE
#define GPIO_Spare_PE8_Pin GPIO_PIN_8
#define GPIO_Spare_PE8_GPIO_Port GPIOE
#define GPIO_Spare_PE9_Pin GPIO_PIN_9
#define GPIO_Spare_PE9_GPIO_Port GPIOE
#define GPIO_Spare_PE10_Pin GPIO_PIN_10
#define GPIO_Spare_PE10_GPIO_Port GPIOE
...
#define Roll_SW_Pin GPIO_PIN_10
#define Roll_SW_GPIO_Port GPIOD
#define Mass_SW_Pin GPIO_PIN_11
#define Mass_SW_GPIO_Port GPIOD
#define Pump_PWM_Pin GPIO_PIN_12
#define Pump_PWM_GPIO_Port GPIOD
#define Pump_DIR_Pin GPIO_PIN_13
#define Pump_DIR_GPIO_Port GPIOD
#define Pump_EN_Pin GPIO_PIN_14
...
#define Pitch_STEP_GPIO_Port GPIOB
#define Pitch_UART_TX_Pin GPIO_PIN_6
#define Pitch_UART_TX_GPIO_Port GPIOB
#define Pitch_UART_RX_Pin GPIO_PIN_7
#define Pitch_UART_RX_GPIO_Port GPIOB
#define Roll_Hall_Pin GPIO_PIN_8
#define Roll_Hall_GPIO_Port GPIOB
#define Pitch_EN_Pin GPIO_PIN_9
#define Pitch_EN_GPIO_Port GPIOB
#define Pitch_DIR_Pin GPIO_PIN_0
